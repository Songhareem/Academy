  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="${pageContext.request.contextPath}/resources/images/header/la.jpg" alt="Los Angeles" style="width:100%;">
      ...
      <div class="item">
        <img src="${pageContext.request.contextPath}/resources/images/header/chicago.jpg" alt="Chicago" style="width:100%;">
        <div class="carousel-caption">
          <h3>Chicago</h3>
      ...
      <div class="item">
        <img src="${pageContext.request.contextPath}/resources/images/header/ny.jpg" alt="New York" style="width:100%;">
        <div class="carousel-caption">
          <h3>New York</h3>
